DROP DATABASE IF EXISTS db_khoitao;
CREATE DATABASE db_khoitao CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE db_khoitao;

-- Xóa b?ng n?u ?ã t?n t?i
DROP TABLE IF EXISTS authorISBN;
DROP TABLE IF EXISTS titles;
DROP TABLE IF EXISTS authors;

CREATE TABLE db_khoitao.authors (
...
CREATE TABLE db_khoitao.titles (
...
CREATE TABLE db_khoitao.authorISBN (
  authorID INT NOT NULL,
  isbn varchar(20) NOT NULL,
  FOREIGN KEY (authorID) REFERENCES db_khoitao.authors (authorID),
  FOREIGN KEY (isbn) REFERENCES db_khoitao.titles (isbn)
);

-- Insert authors
INSERT INTO db_khoitao.authors (firstName, lastName)
VALUES
  ('Paul','Deitel'),
  ('Harvey','Deitel'),
  ('Abbey','Deitel'),
...
-- Insert titles
INSERT INTO db_khoitao.titles (isbn, title, editionNumber, copyright)
VALUES
...
-- Insert authorISBN
INSERT INTO db_khoitao.authorISBN (authorID, isbn)
VALUES
  (1,'0132151006'),
  (2,'0132151006'),
  (3,'0132151006'),
